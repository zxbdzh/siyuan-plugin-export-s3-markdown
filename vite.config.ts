...
export default defineConfig({
  ...
  build: {
    ...
    rollupOptions: {
      ...
      external: ["siyuan", "process"], // 保持思源API为外部依赖

      output: {
        entryFileNames: "index.js",
        chunkFileNames: "index.js", // 合并所有 chunks 到单个文件
        assetFileNames: (assetInfo) => {
          if (assetInfo.name === "style.css") {
            return "index.css";
          }
          return "index.js"; // 将所有其他资源也合并到 JS 文件
        },
        manualChunks: () => "index.js", // 强制所有代码块都合并到index.js
        format: "cjs",
      },
    },
  },
